...
class _PagoMixtoDialogState extends State<PagoMixtoDialog> {
  ...
  bool get _hayRenglonTarjeta => _renglones.any((r) => r.metodo == 'Tarjeta');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // CarritoVentaState.montoRecargoTarjeta y solo aplica cuando
              // metodoPago == 'Tarjeta' de lleno, ver
              // CarritoVentaNotifier.establecerMetodoPago): en un pago mixto
              // ese % queda en 0 para toda la venta, así que si corresponde
              // cobrar recargo en la porción de Tarjeta, el cajero lo suma a
              // mano en el monto de ese renglón.
              if (_hayRenglonTarjeta) ...[
