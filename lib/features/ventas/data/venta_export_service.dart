...
class VentaExportService {
  static const _colorMarca = PdfColor.fromInt(0xFF0D2B4E);
  ...
  Future<Uint8List> generarPdfDetalleVenta(VentaModel venta, NegocioModel negocio, {bool? preciosConIsv}) async {
    // El ISV siempre se cobra en este negocio (excepto en cotizaciones, que
    // todavía no son una venta concretada); [preciosConIsv] solo decide si
  ...
  pw.Page _construirPaginaTicket(VentaModel venta, NegocioModel negocio, pw.MemoryImage? logo, {required bool esCopia, double? anchoMm}) {
    ...
    // El ISV siempre se cobra en este negocio (excepto en cotizaciones).
    final esFacturable = venta.tipoDocumento != 'Cotizacion';
