        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text('Historial de Abonos · ${credito.numeroDocumento}', style: appFont(fontSize: 14.5, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis),
                ),
                IconButton(icon: const Icon(Icons.close, size: 20), onPressed: () => Navigator.pop(context)),
              ],
            ),
            const SizedBox(height: 4),
            Text(credito.nombreCliente, style: appFont(fontSize: 12.5, color: Colors.grey.shade600)),
