              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.upload_file_outlined, color: Color(0xFF0D2B4E)),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
                    child: Text('Importar Ventas a Crédito desde Excel', style: appFont(fontSize: 16.5, fontWeight: FontWeight.w700, color: const Color(0xFF1A1A1A))),
                  ),
        ...
        if (_filas != null) ...[
          ...
          Wrap(
            ...
            children: [
              ...
              if (_conError.isNotEmpty) _badge('${_conError.length} con error (se omiten)', const Color(0xFF0D2B4E)),
            ],
          ),
          const SizedBox(height: 14),
          _tablaPrevia(),
      ...
      child: SingleChildScrollView(
        child: Column(
          children: filas.map((f) {
            final color = f.valido ? const Color(0xFF1A1A1A) : const Color(0xFF0D2B4E);
            return Container(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('Créditos creados', style: appFont(fontSize: 13, color: Colors.grey.shade700)),
              Text('$creados', style: appFont(fontSize: 13, fontWeight: FontWeight.w700)),
            ],
          ),
        ),
      ],
