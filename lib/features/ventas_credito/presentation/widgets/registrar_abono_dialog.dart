          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.payments_outlined, color: Color(0xFF0D2B4E)),
                  ),
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(widget.credito.nombreCliente, style: appFont(fontSize: 12.5, color: Colors.grey.shade600)),
              ),
            ),
            Flexible(
