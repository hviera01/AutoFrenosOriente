            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(producto.nombre, style: appFont(fontSize: 17, fontWeight: FontWeight.w700, color: const Color(0xFF1A1A1A))),
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    if (producto.descripcion.isNotEmpty) ...[
                      Text(producto.descripcion, style: appFont(fontSize: 13, color: Colors.grey.shade600)),
                    ...
                    if (producto.esServicio)
                      _fila('Tipo', 'Servicio (sin control de existencia)')
                    else
  ...
  Widget _fila(String etiqueta, String valor) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 140, child: Text(etiqueta, style: appFont(fontSize: 12.5, color: Colors.grey.shade500))),
          Expanded(child: Text(valor, style: appFont(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFF1A1A1A)))),
        ],
      ),
    );
  }
