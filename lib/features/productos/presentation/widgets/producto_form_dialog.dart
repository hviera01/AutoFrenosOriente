              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 44,
                    decoration: BoxDecoration(
                      color: const Color(0xFF0D2B4E).withOpacity(0.1),
                      borderRadius: BorderRadius.circular(14),
                    ),
                    child: const Icon(Icons.inventory_2_outlined, color: Color(0xFF0D2B4E)),
                  ),
                  ...
                  if (editando && !widget.edicionLimitada)
                    IconButton(
                      ...
                      style: IconButton.styleFrom(
                        backgroundColor: const Color(0xFF0D2B4E).withOpacity(0.08),
    ...
    if (_imagenPreviewBytes != null) {
      ...
      contenido = Column(
        ...
        children: [
          ...
          Text('Foto', style: appFont(fontSize: 10.5, color: Colors.grey.shade500)),
        ],
      );
    }
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: _subiendoImagen
                  ? const SizedBox(width: 22, height: 22, child: CircularProgressIndicator(color: Color(0xFF0D2B4E), strokeWidth: 2.2))
                  : contenido,
            ),
          ),
        ),
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(color: Color(0xFF0D2B4E), shape: BoxShape.circle),
