...
class _IngresosEgresosScreenState extends ConsumerState<IngresosEgresosScreen> {
  ...
  void _mostrarMensaje(String mensaje, {bool esError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(mensaje), backgroundColor: esError ? const Color(0xFF0D2B4E) : null),
    );
  }
  ...
  Widget _totalesFila(TotalesLibro totales, bool esMovil) {
    return Wrap(
      ...
      children: [
        ...
        _statChip('Gastos negocio', totales.gastosNegocio, const Color(0xFF0D2B4E)),
  ...
  Widget _lista(List<MovimientoFinanciero> lista, {bool esMovil = false}) {
    if (_cargando) return const Center(child: CircularProgressIndicator(color: Color(0xFF0D2B4E)));
    if (lista.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14),
              border: Border.all(color: seleccionado ? const Color(0xFF0D2B4E) : const Color(0xFFC7CBD3)),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
