              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.credit_score_outlined, color: Color(0xFF0D2B4E)),
                  ),
                  const SizedBox(width: 14),
                  Expanded(
                    child: Text('Registrar Crédito de Compra', style: appFont(fontSize: 16.5, fontWeight: FontWeight.w700, color: const Color(0xFF1A1A1A))),
                  ),
