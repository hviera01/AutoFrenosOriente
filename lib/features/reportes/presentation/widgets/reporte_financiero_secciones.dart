...
const _paletaUsuarios = [Color(0xFF0D2B4E), Color(0xFF0EA5A4), Color(0xFF3B82F6), Color(0xFF8B5CF6), Color(0xFFEC4899), Color(0xFF22C55E)];
...
Widget seccionUtilidad(ReporteFinancieroData data, bool esMovil) {
  ...
  final filaNeta = Wrap(
    ...
    children: [
      ...
      _flechaOperacion(Icons.drag_handle),
      _stat('Utilidad Neta', data.utilidadNeta, data.utilidadNeta >= 0 ? const Color(0xFF16A34A) : const Color(0xFF0D2B4E)),
    ],
  );
  ...
  return Column(
    ...
    children: [
      ...
      Wrap(
        ...
        runSpacing: 10,
        children: [
          _stat('Servicios (cortes)', data.resumenServiciosProductos.ventasServicios, const Color(0xFF14B8A6), sub: 'Utilidad ${formatearMoneda(data.resumenServiciosProductos.utilidadServicios)}'),
          _flechaOperacion(Icons.drag_handle),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: double.infinity,
              padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14),
              decoration: BoxDecoration(color: flujo.neto >= 0 ? const Color(0xFF16A34A) : const Color(0xFF0D2B4E), borderRadius: BorderRadius.circular(14)),
              child: Row(
