...
/// `Printing.directPrintPdf`) depende del driver de la impresora, y algunos
/// modelos tienen un tamaño de página máximo fijo (por ejemplo, uno
/// registrado como "80 x 210mm") que recorta o reescala cualquier documento
/// más largo que eso, sin importar qué altura declare el PDF -confirmado en
/// la impresora real, ver el comentario grande en traslado_export_service.dart
/// y venta_export_service.dart-.
///
...
class ImpresoraUsbWindowsService {
  ...
  /// llama decida qué hacer sin bloquear el flujo.
  bool imprimir({required String nombreImpresora, required List<int> bytes}) {
    ...
    try {
      ...
      final docNamePtr = 'Ticket'.toNativeUtf16();
