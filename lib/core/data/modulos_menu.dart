...
List<ModuloMenu> obtenerModulos() {
  return [
    ...
    ModuloMenu(
      ...
      subModulos: [
        SubModulo(titulo: 'Vehículos', icono: Icons.directions_car_filled_outlined, moduleKey: 'vehiculos'),
      ],
    ),
    ModuloMenu(
      titulo: 'Créditos',
    ...
    ModuloMenu(
      ...
      subModulos: [
        ...
        SubModulo(titulo: 'Traslados', icono: Icons.sync_alt_outlined, moduleKey: 'reporte_traslados'),
      ],
    ),
  ];
}