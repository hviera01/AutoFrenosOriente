...
/// (traslado, ajuste de stock, venta, compra, etc.): confirma de un vistazo
/// que se guardó, sin interrumpir el flujo (no bloquea nada, se desvanece
/// solo). Usa un OverlayEntry en vez de un diálogo a propósito: no depende
/// de un Navigator ni compite con otros diálogos que puedan abrirse justo
/// después (ej. el de imprimir), y con [IgnorePointer] se puede seguir
/// tocando la pantalla de abajo mientras se desvanece.
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: appFont(fontSize: 14, fontWeight: FontWeight.w700, color: const Color(0xFF1A1A1A)),
                      ),
                    ],
                  ),
                ),
