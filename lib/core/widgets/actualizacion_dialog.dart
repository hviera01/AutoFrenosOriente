...
class _ActualizacionDialogState extends State<_ActualizacionDialog> {
  ...
  // Mismo flujo -sin vueltas- que Daniel's Barber Shop (ver memoria del
  // proyecto): descarga con barra de progreso y abre el instalador. Los
  // intentos anteriores de "mejorar" esto acá no lo arreglaron.
  Future<void> _actualizar() async {
    ...
    try {
      ...
      setState(() {
        _descargando = false;
        _error = 'No se pudo descargar la actualización. Probá de nuevo, o descargala manualmente abajo.';
      });
    }
  }
