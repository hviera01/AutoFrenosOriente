// Para imprimir por ESC/POS (ver TrasladoTicketEscPosService y
// VentaTicketEscPosService): a diferencia de normalizarTexto (que además
// pone todo en minúscula, pensado para comparar/buscar) esto conserva
